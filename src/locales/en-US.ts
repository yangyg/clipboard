export default {
  ...
  settings: {
    ...
    help: {
      ...
      appModes: 'Always on Top',
      appModesText: 'Enable "Always on Top" in Appearance to keep the panel above other windows — ideal for quick paste. The window remembers your last size.',
