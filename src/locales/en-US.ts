export default {
  ...
  preview: {
    ...
    autoExpireProtected: 'Expires in {time} — kept',
    expired: 'Expired',
    expiredProtected: 'Expired — kept by pin/favorite',
    expiredProtectedHint: 'Removing pin or favorite will permanently delete this record; it cannot be restored from trash',
    webLink: 'Web link',
  ...
  settings: {
    ...
    ai: {
      ...
      apiKey: 'API Key',
      model: 'Model name',
      modelDesc: 'The selected name is used for summaries and auto-tags. Base URL and API key stay shared.',
      addModel: 'Add model',
      removeModel: 'Remove model {name}',
      modelCurrent: 'In use',
      modelDuplicate: 'That model name is already in the list',
      modelEmpty: 'Enter a model name',
      modelMax: 'You can save up to 20 model names',
      modelKeepOne: 'Keep at least one model name',
    ...
    privacy: {
      ...
      autoExpire: 'Auto-delete',
      autoExpireDesc: 'Permanently deleted from the database when the timer ends — not moved to trash. 0 marks without deleting.',
      autoExpireNever: 'Never',
      autoExpireSeconds: '{seconds} sec',
      autoExpireMinutes: '{minutes} min',
      autoExpireCompound: '{minutes} min {seconds} sec',
    ...
    help: {
      ...
      privacyProtectionText: 'With "Auto-detect sensitive content" enabled, passwords and verification codes are marked and can be permanently deleted after a set time (not moved to trash). Set the timer to 0 to mark without deleting. In "Privacy" you can add password managers etc. to the ignore list to skip recording their clipboard.',
